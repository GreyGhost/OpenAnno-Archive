...
public:
	...
	*/
	...
	/* This function was added to give the possibility to write 
	 * the data in a formatted way to a stream */
	virtual void toStream( std::ostream& stream, int depth) const = 0;
...
public:
	...
	*/
	...
	virtual void toStream( std::ostream& stream, int depth) const;
...
public:
	...
	*/
	...
	/// Save a file through PHYSFS using the given filename. Returns true if successful.
	bool PHYSFS_SaveFile( const char * filename ) const;
	...
	*/
	...
	/* Reads File thorugh PHYSFS: */
	bool PHYSFS_LoadFile( const std::string& file, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
