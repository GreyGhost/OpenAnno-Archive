...
LoginDialog::LoginDialog(int x, int y, int width, int height, const std::string& background) : Dialog(x, y, width, height, background, 0)
{
	int pX = 50, pY = 40;
	Widget* temp;
...
void LoginDialog::onCommand(EventCommand* event)
{
